...
class StudentSubmissionTest extends TestCase {
	...
	public function test_student_can_submit_form_with_image(): void {
		...
		$response->assertJsonStructure([
			'message',
			'data' => ['id', 'first_name', 'last_name', 'class', 'school_name', 'grade', 'image'],
		]);
	...
	public function test_student_submission_fails_without_required_fields(): void {
		...
		$response->assertJsonValidationErrors(['second_name', 'third_name', 'last_name', 'gender', 'governorate', 'class', 'school_name', 'grade', 'image']);
	}
